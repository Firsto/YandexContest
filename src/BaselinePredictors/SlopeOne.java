...
public class SlopeOne {
    ...
    public static void main(String args[]){
        ...
        // items
        ItemId item1 = new ItemId("       item1");
        ItemId item2 = new ItemId("       item2");
        ItemId item3 = new ItemId("       item3");

        mAllItems = new ItemId[]{item1, item2, item3};
        ...
        user1.put(item1,9.0f);
        user1.put(item2,8.0f);
        data.put(new UserId("User 1"),user1);
        user2.put(item2,4.0f);
        user2.put(item3,6.0f);
        data.put(new UserId("User 2"),user2);
        user3.put(item3,7.0f);
        data.put(new UserId("User 3"),user3);
        ...
        SlopeOne.print(so.predict(user2));
        System.out.println("User3:");
        SlopeOne.print(so.predict(user3));
    }
